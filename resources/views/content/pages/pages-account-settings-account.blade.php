...
@section('content')
    ...
    <div class="row">
        <div class="col-md-12">
            ...
            <form action="/process/edit" method="POST" enctype="multipart/form-data">
              @csrf
                <div class="card mb-4">
                    ...
                    <div class="card-body">
                        <div class="d-flex align-items-start align-items-sm-center gap-4">
                            ...
                            @else
                                <img src="{{ asset('storage/assets/img/avatars/' . Auth::user()->avatar) }}" alt="user-avatar"
                                    class="d-block w-px-120 h-px-120 rounded" id="uploadedAvatar" />
                            @endif
                            ...
                            <div class="row mt-2 gy-4">
                                <div class="col-md-6" hidden>
                                    <div class="form-floating form-floating-outline">
                                        <input class="form-control" type="text" id="id" name="id"
                                            value="{{ Auth::user()->id_user }}" autofocus />
                                ...
                                <div class="col-md-6">
                                    <div class="form-floating form-floating-outline">
                                        ...
                                        <span class="small" style="color: red;">*Jika Ada Perubahan Silahkan Masukkan Password Baru.</span>
                                    </div>
                                </div>
                            </div>
                            <div class="mt-4">
